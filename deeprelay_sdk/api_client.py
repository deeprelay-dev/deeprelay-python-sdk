...
from deeprelay_sdk.api_response import ApiResponse, T as ApiResponseT
import deeprelay_sdk.models
from deeprelay_sdk import rest
from deeprelay_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'deeprelay-sdk-python/0.1.1'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(deeprelay_sdk.models, klass)
