...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.deeprelay.ai/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("deeprelay_sdk")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        if self.access_token is not None:
            auth['bearerAuth'] = {
                'type': 'bearer',
                'in': 'header',
                'format': 'deeprelay_live_<24-base62>',
                'key': 'Authorization',
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "https://api.deeprelay.ai/v1",
                'description': "Production",
            },
            {
                'url': "https://api.demo.deeprelay.ai/v1",
                'description': "Demo",
            }
        ]
