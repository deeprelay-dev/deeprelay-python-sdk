...
class SubscriptionPortalRequest(BaseModel):
    ...
    """ # noqa: E501
    return_url: Optional[StrictStr] = Field(default=None, description="Where the provider returns when the customer leaves the portal. Defaults to the deployment's configured URL.")
