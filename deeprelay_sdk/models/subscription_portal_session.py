...
class SubscriptionPortalSession(BaseModel):
    """
    SubscriptionPortalSession
    """ # noqa: E501
    portal_url: StrictStr = Field(description="The hosted billing portal — cancel, resume, change payment method, download invoices.")
