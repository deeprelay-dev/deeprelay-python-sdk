...
class EmbeddingsResponse(BaseModel):
    ...
    object: StrictStr
    data: List[Embedding]
    model: StrictStr = Field(description="Canonical (deeprelay/...) model id, NEVER the upstream identifier.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "model": obj.get("model"),
            "usage": EmbeddingsUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None
        })
        return _obj
