...
class InferenceApi:
    ...
    def create_embeddings(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '403': "OpenAIErrorEnvelope",
            '404': "OpenAIErrorEnvelope",
            '413': "OpenAIErrorEnvelope",
            '429': "OpenAIErrorEnvelope",
            '500': "OpenAIErrorEnvelope",
            '502': "OpenAIErrorEnvelope",
            '503': "OpenAIErrorEnvelope",
    ...
    @validate_call
    def inference_preflight(
        self,
        model: Annotated[StrictStr, Field(description="Model id or alias, optionally with a `:economy` tier suffix. It is resolved through the catalog exactly as the inference endpoints resolve it, so an alias and a tier view answer for the model that would actually serve.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param model: Model id or alias, optionally with a `:economy` tier suffix. It is resolved through the catalog exactly as the inference endpoints resolve it, so an alias and a tier view answer for the model that would actually serve. (required)
        :type model: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._inference_preflight_serialize(
            model=model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def inference_preflight_with_http_info(
        self,
        model: Annotated[StrictStr, Field(description="Model id or alias, optionally with a `:economy` tier suffix. It is resolved through the catalog exactly as the inference endpoints resolve it, so an alias and a tier view answer for the model that would actually serve.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InferencePreflight]:
        """Check whether a model request would be served, and at whose expense
    ...
    @validate_call
    def inference_preflight_without_preload_content(
        self,
        model: Annotated[StrictStr, Field(description="Model id or alias, optionally with a `:economy` tier suffix. It is resolved through the catalog exactly as the inference endpoints resolve it, so an alias and a tier view answer for the model that would actually serve.")],
        _request_timeout: Union[
            None,
    ...
    def _inference_preflight_serialize(
        self,
        model,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/inference/preflight',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
