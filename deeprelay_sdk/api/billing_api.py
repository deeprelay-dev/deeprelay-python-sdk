...
class BillingApi:
    ...
    def delete_spending_limit(
        ...
        _param = self._delete_spending_limit_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def delete_spending_limit_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def delete_spending_limit_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _delete_spending_limit_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
