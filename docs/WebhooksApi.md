...
with deeprelay_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = deeprelay_sdk.WebhooksApi(api_client)
    create_webhook_endpoint_request = deeprelay_sdk.CreateWebhookEndpointRequest() # CreateWebhookEndpointRequest | 
